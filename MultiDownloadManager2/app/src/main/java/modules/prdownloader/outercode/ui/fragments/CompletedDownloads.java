...
import static modules.general.ui.utils.adapters.CustomRecyclerViewAdapter.CompletedDownloadsVHType;


public class CompletedDownloads extends BaseDownloadsFragment<DownloadsFrgPresenter> implements
...

{
    ...
    public void configureUI() {
        ...
        downloadsAdapter = new CustomRecyclerViewAdapter<Download>(getContainerActivity(),
                CompletedDownloadsVHType);
        ...
        rv.addItemDecoration(
                new HorizontalDividerItemDecoration.Builder(getContainerActivity())
                        ...
                        //.marginResId(R.dimen.leftmarginDivider ,  R.dimen.rightmarginDivider)
                        .build());
