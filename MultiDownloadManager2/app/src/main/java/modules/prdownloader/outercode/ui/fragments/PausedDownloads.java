...
import static modules.general.ui.utils.adapters.CustomRecyclerViewAdapter.PausedDownloadsVHType;


public class PausedDownloads extends BaseDownloadsFragment<DownloadsFrgPresenter> implements
...

{
    ...
    public void configureUI() {
        ...
        downloadsAdapter = new CustomRecyclerViewAdapter<Download>(getContainerActivity(), PausedDownloadsVHType);
