...
package modules.prdownloader.library.utils;
...
import modules.prdownloader.library.database.DownloadModel;
...
public final class Utils {
    ...
    public static void deleteTempFileAndDatabaseEntryInBackground(final String path, final String downloadId) {
    ...
    public static String getUniqueId(String url, String dirPath, String fileName) {
